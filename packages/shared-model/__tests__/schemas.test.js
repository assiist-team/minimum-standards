...
describe('shared Zod schemas', () => {
    test('Activity happy path', () => {
        const parsed = schemas_1.activitySchema.parse({
            id: 'a1',
            name: 'Sales Calls',
            unit: 'calls',
            createdAtMs: 1,
    ...
    test('Activity rejects empty name', () => {
        expect(() => schemas_1.activitySchema.parse({
            id: 'a1',
            name: '',
            unit: 'calls',
            createdAtMs: 1,
    ...
    test('Standard happy path with new cadence structure', () => {
        const parsed = schemas_1.standardSchema.parse({
            id: 's1',
            activityId: 'a1',
            minimum: 100,
            unit: 'calls',
    ...
    test('Standard rejects invalid cadence structure', () => {
        expect(() => schemas_1.standardSchema.parse({
            id: 's1',
            activityId: 'a1',
            minimum: 100,
            unit: 'calls',
    ...
    test('ActivityLog happy path', () => {
        const parsed = schemas_1.activityLogSchema.parse({
            id: 'l1',
            standardId: 's1',
            value: 14,
            occurredAtMs: 123,
    ...
    test('ActivityLog rejects negative value', () => {
        expect(() => schemas_1.activityLogSchema.parse({
            id: 'l1',
            standardId: 's1',
            value: -1,
            occurredAtMs: 123,
